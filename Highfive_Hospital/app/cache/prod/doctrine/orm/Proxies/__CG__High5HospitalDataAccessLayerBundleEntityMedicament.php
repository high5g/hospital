 ...
 */
class Medicament extends \High5\Hospital\DataAccessLayerBundle\Entity\Medicament implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'High5\\Hospital\\DataAccessLayerBundle\\Entity\\Medicament' . "\0" . 'id', '' . "\0" . 'High5\\Hospital\\DataAccessLayerBundle\\Entity\\Medicament' . "\0" . 'libelle', '' . "\0" . 'High5\\Hospital\\DataAccessLayerBundle\\Entity\\Medicament' . "\0" . 'categorie', '' . "\0" . 'High5\\Hospital\\DataAccessLayerBundle\\Entity\\Medicament' . "\0" . 'quantite', '' . "\0" . 'High5\\Hospital\\DataAccessLayerBundle\\Entity\\Medicament' . "\0" . 'fkHopital');
        }
